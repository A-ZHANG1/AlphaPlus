...
import org.pmf.alphaplus.ui.EdgeBean;
import org.pmf.alphaplus.ui.NodeBean;
import org.pmf.alphaplus.ui.UnionEdge;
...
public class AlphaPetriNetGraph {
    ...
    public AlphaPetriNetGraph(PetriNet petriNet) {
        ...
        // 初始化graph
        model = new DefaultGraphModel();//look into this method
...
//见sandBox/HelloWorld.java
    ...
    private void fillGraphData() {
        ...
        for (Place place : petriNet.places) {
            // 库所结点
            NodeBean placeNode = new NodeBean("",0);//TYPE_NODE_PLACE = 0;
    ...
    private void addEdge(NodeBean source, NodeBean target, int weight, String edgeString) {
        ...
        // 建立GEF的 node edge将来用来计算graph node的layout line254
